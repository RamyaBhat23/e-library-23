...
<head>
    ...
    <link rel="stylesheet" href="<?php echo WWW_ROOT.'/styles/login.css'?>">
...
<body>
    <div id="center">
        ...
        <form action="<?php echo WWW_ROOT.'/check.php'?>" method="POST" class="myform">
            ...
            <div>
                <input type="submit" value="Login" class="btn buttons">
                <a href="<?php echo WWW_ROOT.'/reset.php'?>"><input type="button" value="Forgot password?" class="btn buttons"></a>
            </div>
        </form>
    </div>
</body>
